...
class UserRegistrationTests {
    ...
    void newUserRegistration_mandatoryParametersProvided_createsNewUserRegistrationForUserHandleAndPhoneNumber() {
        ...
        // act
        UserRegistration userRegistration = userRegistrationFactory.newInstance(userHandle, phoneNumber);
    ...
    void newUserRegistration_userHandleNotProvided_throwsMandatoryParameterMissingException() {
        ...
        // act + assert
        assertThrows(MandatoryParameterMissingException.class, () -> userRegistrationFactory.newInstance(userHandle, phoneNumber), "mandatory parameter 'userHandle' is missing");
    }
    ...
    void newUserRegistration_phoneNumberNotProvided_throwsMandatoryParameterMissingException() {
        ...
        // act + assert
        assertThrows(MandatoryParameterMissingException.class, () -> userRegistrationFactory.newInstance(userHandle, phoneNumber), "mandatory parameter 'phoneNumber' is missing");
    }
    ...
    void newUserRegistration_existingUserRegistrationWithSameUserHandle_throwsUserHandleAlreadyInUseException() {
        ...
        // act
        assertThrows(UserHandleAlreadyInUseException.class, () -> userRegistrationFactory.newInstance(userHandle, phoneNumber));
    ...
    @Test
    void complete_userRegistrationWithVerifiedPhoneNumberAndFullNameProvided_marksUserRegistrationAsCompleted() {
        // arrange
        UserHandle userHandle = userHandle("peter");
        PhoneNumber phoneNumber = phoneNumber("+41 79 123 45 67");
