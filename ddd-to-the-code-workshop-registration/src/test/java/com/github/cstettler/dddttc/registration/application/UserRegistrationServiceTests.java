...
class UserRegistrationServiceTests {
    ...
    void startNewUserRegistrationProcess_userHandleAndPhoneNumberProvided_addsNewUserRegistrationInRepositoryAndReturnsAggregateId() {
        ...
        UserRegistrationService userRegistrationService = new UserRegistrationService(userRegistrationFactory(userRegistration), userRegistrationRepository, null);
    ...
    void verifyPhoneNumber_existingUserRegistrationIdAndValidVerificationCodeProvided_verifiesPhoneNumberAndUpdatesUserRegistrationInRepository() {
        ...
        UserRegistrationService userRegistrationService = new UserRegistrationService(null, userRegistrationRepository, null);
    ...
    @Test
    void completeUserRegistration_existingUserRegistrationIdAndFullNameProvided_completesUserRegistrationUpdatesUserRegistrationAndPublishesUserRegistrationCompletedEvent() {
        // arrange
        UserRegistrationId userRegistrationId = userRegistrationId("user-registration-1");
        UserHandle userHandle = userHandle("peter");
        PhoneNumber phoneNumber = phoneNumber("+41 79 123 45 67");
        ...
        UserRegistrationService userRegistrationService = new UserRegistrationService(null, userRegistrationRepository, domainEventPublisher);
    ...
    private static UserRegistrationFactory userRegistrationFactory(UserRegistration userRegistration) {
        ...
        when(userRegistrationFactory.newInstance(userRegistration.userHandle(), userRegistration.phoneNumber())).thenReturn(userRegistration);
