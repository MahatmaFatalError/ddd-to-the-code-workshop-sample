...
import static com.github.cstettler.dddttc.rental.domain.BikeAlreadyBookedException.bikeAlreadyBooked;
import static com.github.cstettler.dddttc.rental.domain.Booking.newBooking;
...
public class Bike {
    ...
    Booking bookBikeFor(User user, Clock clock) throws BikeAlreadyBookedException {
        if (this.userId != null) {
