...
public class UserRegistration {
    ...
    private UserRegistration(DomainEventPublisher domainEventPublisher, UserHandle userHandle, PhoneNumber phoneNumber) {
        ...
        domainEventPublisher.publish(phoneNumberVerificationCodeGenerated(this.phoneNumber, this.phoneNumberVerificationCode));
    }
    ...
    public void verifyPhoneNumber(VerificationCode verificationCode) throws PhoneNumberVerificationCodeInvalidException {
    ...
    public static class UserRegistrationFactory {
        ...
        public UserRegistration newInstance(UserHandle userHandle, PhoneNumber phoneNumber) throws UserHandleAlreadyInUseException {
