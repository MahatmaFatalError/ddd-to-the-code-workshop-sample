...
import static com.github.cstettler.dddttc.rental.domain.BikeUsage.bikeUsage;
import static com.github.cstettler.dddttc.rental.domain.BookingAlreadyCompletedException.bookingAlreadyCompleted;
import static com.github.cstettler.dddttc.rental.domain.BookingCompletedEvent.bookingCompleted;
import static com.github.cstettler.dddttc.rental.domain.BookingId.newBookingId;
...
public class Booking {
    ...
    static Booking newBooking(NumberPlate numberPlate, UserId userId, DomainEventPublisher domainEventPublisher, Clock clock) {
